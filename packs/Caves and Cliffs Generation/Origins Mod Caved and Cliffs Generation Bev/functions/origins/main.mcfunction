...
tag @e[type=origins:origins,y=-64,r=3,c=1] add origins:origins_counter
...
execute @p[tag=origins:origins_summon] ~~~ summon origins:origins ~~-63~
...
fill ~~-64~ ~~-63~ bedrock
tp @e[type=origins:origins,y=-64,r=3,c=1] ~~-63~
tp @e[family=origin_group] ~~-63~

#origin groups and above highest origin group check
scoreboard players set @e[type=origins:origins,y=-64,r=3,c=1] origin_groups 0
scoreboard players set @e[family=origin_group,y=-64,r=3] dummy_value 1
scoreboard players operation @e[type=origins:origins,y=-64,r=3,c=1] origin_groups += @e[family=origin_group,r=3] dummy_value
scoreboard players operation @a dummy_value = @e[type=origins:origins,y=-64,r=3,c=1] origin_groups
...
tp @e[type=origins:spare_inventory,tag=!origins:used] ~~-63~
