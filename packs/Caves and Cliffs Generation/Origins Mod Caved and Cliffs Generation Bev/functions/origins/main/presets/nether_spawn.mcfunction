...
execute @s[tag=origins:nether_spawn2] ~~~ fill 1 -64 1 3 -61 3 bedrock 0 hollow
execute @s[tag=origins:nether_spawn2] ~~~ setblock 2 -63 2 portal
tp @s[tag=origins:nether_spawn2] 2 -63 2
