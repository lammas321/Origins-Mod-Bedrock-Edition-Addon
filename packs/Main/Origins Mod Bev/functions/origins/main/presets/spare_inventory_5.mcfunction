...
execute @s[scores={dummy_value=0}] ~~~ summon origins:spare_inventory ~~~ origins:slots_5
...
event entity @e[type=origins:spare_inventory,family=slots_9,scores={origin_playerid=0}] origins:slots_5
event entity @e[type=origins:spare_inventory,family=slots_27,scores={origin_playerid=0}] origins:slots_5
